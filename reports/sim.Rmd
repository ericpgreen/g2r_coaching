...
We can use this to identify the most and least effective coaches and then qualitatively explore their records to generate some hypotheses about why some coaches appear to have more impact on participants than others.

For instance, we could identify the coaches in each setting who are +/- 1 SD away from the population-level effect.
...
We could then look qualitatively at each top/bottom coach's case records to generate ideas about what makes someone a top or bottom coach.
