...
The first step is to create a function to simulate data for this structure. 
...
2. They account for the multilevel nature of the design with bootstrapping.
...
For this exercise we'll fit a mixed model and incorporate information about setting as a fixed effect:
